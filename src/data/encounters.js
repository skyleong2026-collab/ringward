...
export const ENCOUNTERS = [
  ...
  },
  {
    id: 'the-swarm',
    name: 'The Swarm',
    flavor: 'Seven Reactors flickering in the dark. Weak alone. Terrifying together. Can you carry?',
  ...
  // ── Harder encounters: test Core mechanics and force proc chains ──
  {
    id: 'overdrive',
    name: 'Overdrive',
    flavor: 'A Swift and two Reactors accelerating. By round 3 they hit like meteors. Kill fast or lose.',
  ...
  },
  {
    ...
    flavor: 'One Guardian holding five Reactors. Each ally fall feeds their flame. Breaks you or breaks itself.',
